        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClothType = table.Column<string>(maxLength: 30, nullable: true),
                    ShoesType = table.Column<string>(maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<string>(nullable: false),
                    DanceGroupName = table.Column<string>(maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<string>(nullable: false),
                    SongName = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<string>(nullable: false),
                    FolkDanceName = table.Column<string>(maxLength: 30, nullable: true),
                    FolkDanceSize = table.Column<string>(maxLength: 10, nullable: true),
                    FolkDanceRegion = table.Column<string>(maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticeTime = table.Column<string>(maxLength: 10, nullable: true),
                    DanceGroupId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
